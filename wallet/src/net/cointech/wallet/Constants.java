...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_BACKUP = "aurumcoin-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	private static final String EXPLORE_BASE_URL_PROD = "https://aurumblocks.cointech.net/";
	private static final String EXPLORE_BASE_URL_TEST = "https://aurumblocks.cointech.net/testnet/";
	...
	private static final String BITEASY_API_URL_PROD = "https://aurumblocks.cointech.net/chain/AurumCoin/";
	private static final String BITEASY_API_URL_TEST = "https://aurumblocks.cointech.net/testnet/chain/AurumCoin/";
	...
	public static final String VERSION_URL = "https://cointech.net/aurumcoin-wallet-version";

	/** MIME type used for transmitting single transactions. */
	public static final String MIMETYPE_TRANSACTION = "application/x-autx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-aurumcoin-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "Aurumcoin Wallet";

	/** Default currency to use if all default mechanisms fail. */
	public static final String DEFAULT_EXCHANGE_CURRENCY = "BGN";

	/** Donation address for tip/donate action. */
	public static final String DONATION_ADDRESS = "12yUuH4b5bJgcdAJTwWmm3YbPo3brA9KHJ";

	/** Recipient e-mail address for reports. */
	public static final String REPORT_EMAIL = "support@cointech.net";
