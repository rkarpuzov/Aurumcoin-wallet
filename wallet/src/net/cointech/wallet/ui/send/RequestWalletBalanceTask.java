...
//					url.append("&address[]=").append(address.toString());
                                       url.append("\u007C").append(address.toString());
...
//								throw new IllegalStateException("UXTO not spent");
							...
							final Sha256Hash uxtoHash = new Sha256Hash(jsonOutput.getString("tx_hash")); //transaction_hash
							final int uxtoIndex = jsonOutput.getInt("tx_output_n"); // transaction_index
							final byte[] uxtoScriptBytes = Constants.HEX.decode(jsonOutput.getString("script")); // script_pub_key
