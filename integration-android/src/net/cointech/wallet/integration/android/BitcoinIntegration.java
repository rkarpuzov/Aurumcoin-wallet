...
package net.cointech.wallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("aurumcoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=net.cointech.wallet"));
